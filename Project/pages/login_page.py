...
class LoginPage(BasePage):
    ...
    def should_be_login_url(self): #проверка на соответствие ссыдки с login
        current_url = self.browser.current_url
        assert "login" in current_url, "URL not contains 'login'"

    def should_be_login_form(self): #проверка на наличие форм логина и пароля
        assert self.is_element_present(*LoginPageLocators.LOGIN_FORM), "Login form is not presented"

    def should_be_register_form(self): #проверка на наличие форм регистрации
